...
export default class ByProduct extends Component {
                ...
                {(value) => {
                    const numberOfItems = () => {
                        ...
                        for(let i=0; i<value.products.length; i++){
                            for(let j=0; j<value.products[i].product.length; j++){
                                if(value.products[i].product[j] === nameValue){
                                    arrItems+=1;
                                }}};
                            return arrItems;
                    };
